        ...
        <div class="modal">
            <div class="modal__card">
                <div class="modal__card__container">
                    <small class="modal__card__container__progress-text"
                        >Step 1 of 2</small
                    >
                    <div
                    ...
                    <input
                        ...
                        required=""
                    />
                    <SubmitButton title="Send Me The Tips »" />
                </div>
...
Vue.component("SubmitButton", {
    props: ["title"],
    template:
        '<button class="modal__card__container__gradient-button" type="submit" >{{ title }}</button>'
});
